...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_XA_RBROLLBACK = 1402; //SQLSTATE: XA100 Message: XA_RBROLLBACK: Transfert branch was rolled back
    ...
    public final static int ER_CANT_CHANGE_TX_ISOLATION = 1568; //SQLSTATE: 25001 Message: Transfert isolation level can't be changed while a transaction is in progress
    ...
    public final static int ER_XA_RBTIMEOUT = 1613; //SQLSTATE: XA106 Message: XA_RBTIMEOUT: Transfert branch was rolled back: took too long
    public final static int ER_XA_RBDEADLOCK = 1614; //SQLSTATE: XA102 Message: XA_RBDEADLOCK: Transfert branch was rolled back: deadlock was detected
    ...
    public final static int ER_WARN_ENGINE_TRANSACTION_ROLLBACK = 1622; //SQLSTATE: HY000 Message: Storage engine %s does not support rollback for this statement. Transfert rolled back and must be restarted
    @Deprecated
    ...
    public final static int ER_GNO_EXHAUSTED = 1775; //SQLSTATE: HY000 Message: Impossible to generate Global Transfert Identifier: the integer component reached the maximal value. Restart the server with a new server_uuid.
    @Deprecated
